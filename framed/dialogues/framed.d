...
*/
ADD_TRANS_ACTION DELTAN BEGIN 6 END BEGIN END ~TakePartyItem("#LF_CKWO") DestroyItem("#LF_CKWO") EraseJournalEntry(@3001)~
I_C_T DELTAN 6 ~#LF_ELTAN_TAKE_CKWO~
== DELTAN IF ~GlobalLT("Teth","GLOBAL",2)~ THEN @2200 // ~Oh, by the way, we received a messenger from Candlekeep. They managed to clear enough of the spiders for their purposes. You'll not be needing that work order any more.~
DO ~TakePartyItem("#LF_CKWO") DestroyItem("#LF_CKWO") EraseJournalEntry(@3001)~
END
